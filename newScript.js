...
async function main() {
    ...
    const provider = new ethers.providers.InfuraProvider("goerli", "472154f64c7144f7853594f0b401a43e");
    var signer = new ethers.Wallet(process.env.REACT_APP_PRIVAT_KEY, provider);
    var signer2 = new ethers.Wallet(process.env.REACT_APP_PRIVAT_KEY_2, provider);

    //const [signer, signer2] = await ethers.getSigners();

    const contractABI__ = require("./zkCards-ABI.json");
    const zkCards = new ethers.Contract("0x2de4270093D550F5bAFe462A583eC0b712796aAd", contractABI__, signer);
